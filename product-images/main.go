...
import (
	...
	"github.com/jollyboss/go-microservices/product-images/files"
	"github.com/jollyboss/go-microservices/product-images/handlers"
...
func main() {
	...
	// gracefully shutdown the server, waitingn max 30s for current operations to complete
